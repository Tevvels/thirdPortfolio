...
function PuzzleDPieceThree() {

     const header = React.createRef();

    useEffect(()=>{
      gsap.to(header.current,{color: '#8c3',duration: 2})
    },[header])
  ...
  return (
    <Tile positive={'-'} parallax={0.76} className={`puzzle puzzle_d puzzle_piece puzzle_d_piece puzzle_d_piece-three`} ref={header}>
    
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="150 250 120 120">
...
export default PuzzleDPieceThree;
