...
function PuzzleDPieceTwo() {
  return (
    <Tile positive={'-'} parallax={0.76} className={`puzzle puzzle_d puzzle_piece puzzle_d_piece puzzle_d_piece-two`}>

    <svg xmlns="http://www.w3.org/2000/svg" viewBox="270 240 135 135">
