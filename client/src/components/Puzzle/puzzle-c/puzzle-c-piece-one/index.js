...
function PuzzleCPieceOne() {
  return (
    <Tile positive={''} parallax={0.74} className={`puzzle puzzle_c puzzle_piece  puzzle_c_piece puzzle_c_piece-one`}>

    <svg xmlns="http://www.w3.org/2000/svg" viewBox="-15 220 110 110">
